...
- Penulis menemukan bahwa huruf yang digunakan dalam soal adalah huruf latin yang "unik". Kemudian penulis menggunakan situs [Cryptii](https://cryptii.com/pipes/caesar-cipher) untuk mendecode soal. 
- Penulis menggunakan metode ***Alphabetical substitution***. Penulis memasukkan plaintext alphabet dan chiper alphabet dengan perbandingan huruf unik pada website [Jrgraphix](https://jrgraphix.net/r/Unicode/00A0-00FF) ini.
- Setelah soal di decode, hasilnya adalah akan didapat flagnya.
____________________________________
